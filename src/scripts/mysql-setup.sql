...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, SHOW VIEW ON `cardholder`.* TO `cardholderuser`@`%`;
FLUSH PRIVILEGES;
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, SHOW VIEW ON `card`.* TO `carduser`@`%`;
FLUSH PRIVILEGES;
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, SHOW VIEW ON `pan`.* TO `panuser`@`%`;
FLUSH PRIVILEGES;